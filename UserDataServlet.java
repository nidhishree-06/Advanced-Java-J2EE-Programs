 ...
 * with client sided validation and submit to the servlet called UserDataServlet and process 
 * all the fields with server sided validation and display all the data through result.jsp with a link to move to the client side
 */
